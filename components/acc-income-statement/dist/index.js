...
export default function JournalEntriesList() {
    var _data_, _data__field_credit_account, _data_1;
    /* --------------------------------------------------
 ...
 */ const [debitTotal, setDebitTotal] = useState('');
    ...
    useEffect(()=>{
        const debit = data === null || data === void 0 ? void 0 : data.reduce((sum, i)=>sum + Number((i === null || i === void 0 ? void 0 : i.field_amount) || 0), 0);
        const credit = data === null || data === void 0 ? void 0 : data.reduce((sum, i)=>sum + Number((i === null || i === void 0 ? void 0 : i.field_amount) || 0), 0);
        setDebitTotal(debit);
        setCreditTotal(credit);
    }, [
        data
    ]);
    console.log(data && ((_data_ = data[1]) === null || _data_ === void 0 ? void 0 : _data_.field_credit_account));
    console.log(data && ((_data_1 = data[1]) === null || _data_1 === void 0 ? void 0 : (_data__field_credit_account = _data_1.field_credit_account) === null || _data__field_credit_account === void 0 ? void 0 : _data__field_credit_account.field_amount));
...
-------------------------------------------------**/ const [drGrouped, setDrGrouped] = useState([]);
  ...
  Credit Items - Grouped by Taxnomy Term(Acount Type)
    ...
    /** GET TOTAL BY TAXONOMY **/ const getDebitTotalByTaxonomy = (taxonomyName)=>{
 ...
 * EXPORT LEDGER DETAILS IN CSV 
 ---------------------------------------------------*/ const exportTrialBalanceCSV = ()=>{
        ...
        // Debit Accounts
        drGrouped === null || drGrouped === void 0 ? void 0 : drGrouped.forEach((group)=>{
            var _group_items;
            (_group_items = group.items) === null || _group_items === void 0 ? void 0 : _group_items.forEach((item)=>{
                rows.push([
                    item.title,
                    group.taxonomyName,
                    item.dr_amount || 0,
        ...
        // Credit Accounts
        crGrouped === null || crGrouped === void 0 ? void 0 : crGrouped.forEach((group)=>{
            var _group_items;
            (_group_items = group.items) === null || _group_items === void 0 ? void 0 : _group_items.forEach((item)=>{
                rows.push([
                    item.title,
   ...
   *-----------------------------------------------------*/ const exportIncomeStatementToCSV = ()=>{
        const rows = [
            ...
            [
                "Operating Profit",
                netRevenue - (netCogsExpenses + netExpense)
            ],
            [
                "Tax Expenses",
                netTaxExpenses
  ...
  -------------------------------------------------- */ return /*#__PURE__*/ _jsxs("div", {
        children: [
            ...
            /*#__PURE__*/ _jsxs("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ _jsxs("div", {
                        ...
                        children: [
                            /*#__PURE__*/ _jsx("div", {
                                children: "Less: Expenses (cost of goods sold)"
                            }),
                            /*#__PURE__*/ _jsx("div", {
                                children: /*#__PURE__*/ _jsx(Amount, {
                                    amt: netCogsExpenses
                    ...
                    /*#__PURE__*/ _jsxs("div", {
                        className: "grid grid-cols-2 border-b mb-2",
                        children: [
                            /*#__PURE__*/ _jsx("div", {
                                className: "uppercase",
                            ...
                            /*#__PURE__*/ _jsx("div", {
                                children: /*#__PURE__*/ _jsx(Amount, {
                                    amt: netRevenue - netCogsExpenses
                                })
                            })
                        ]
                    }),
                    /*#__PURE__*/ _jsxs("div", {
                        ...
                        children: [
                            /*#__PURE__*/ _jsx("div", {
                                children: "Less: Operating Expenses"
                            }),
                            /*#__PURE__*/ _jsx("div", {
                                children: /*#__PURE__*/ _jsx(Amount, {
                                    amt: netExpense
                    ...
                    /*#__PURE__*/ _jsxs("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ _jsx("div", {
                                children: /*#__PURE__*/ _jsx(Amount, {
                                    amt: netRevenue - (netCogsExpenses - netExpense)
                                })
                            })
                        ]
                    }),
                    /*#__PURE__*/ _jsxs("div", {
                        className: "grid grid-cols-2 mb-2 border-b",
                        children: [
                            /*#__PURE__*/ _jsx("div", {
                                children: "Less: Tax Expenses"
                            }),
                            /*#__PURE__*/ _jsx("div", {
                                children: /*#__PURE__*/ _jsx(Amount, {
                                    amt: netTaxExpenses
            ...
            drGrouped && drGrouped.map((item)=>{
                ...
                return /*#__PURE__*/ _jsxs("div", {
                    className: "my-2 border-b border-slate-300",
                    children: [
                        /*#__PURE__*/ _jsxs("div", {
                            className: "text-sm font-bold uppercase grid grid-cols-2 gap-2",
                            children: [
                                /*#__PURE__*/ _jsxs("div", {
                                    children: [
                                        "Total - ",
                                ...
                                /*#__PURE__*/ _jsx("div", {
                                    children: (_item_items = item.items) === null || _item_items === void 0 ? void 0 : _item_items.reduce((sum, i)=>sum + Number(i.dr_amount || 0), 0).toFixed(2)
                                })
                            ]
                        }),
                        (_item_items1 = item.items) === null || _item_items1 === void 0 ? void 0 : _item_items1.map((jr)=>{
                            return /*#__PURE__*/ _jsxs("div", {
                                className: "grid grid-cols-3 gap-2",
                                children: [
                                    /*#__PURE__*/ _jsx("div", {
                                        children: /*#__PURE__*/ _jsx("a", {
                                            href: `/ledger-account/?ledgerId=${jr.ledgerId}`,
                                            children: jr.title
                                        })
                                    }),
                                    /*#__PURE__*/ _jsx("div", {
                                        className: "text-xs pl-1",
                                        children: item.taxonomyName
                                    }),
                                    /*#__PURE__*/ _jsx("div", {
                                        children: jr.dr_amount
                                    })
                                ]
                            }, jr.id);
                        })
                    ...
                    children: [
                        /*#__PURE__*/ _jsxs("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ _jsx("div", {
                                    children: (_item_items = item.items) === null || _item_items === void 0 ? void 0 : _item_items.reduce((sum, i)=>sum + Number(i.cr_amount || 0), 0).toFixed(2)
                                })
                            ]
                        }),
                        (_item_items1 = item.items) === null || _item_items1 === void 0 ? void 0 : _item_items1.map((jr)=>{
